...
if("TRUE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /home/bigworld/catkin_ws/src/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /home/bigworld/catkin_ws/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /home/bigworld/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bigworld/catkin_ws/src/robot_setup_tf/${idir}'.  ${_report}")
    endif()
